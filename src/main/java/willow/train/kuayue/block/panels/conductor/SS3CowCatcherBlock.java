...
public class SS3CowCatcherBlock extends FullShapeDirectionalBlock implements ConductorProvider {
    public SS3CowCatcherBlock(Properties pProperties, Vec2 beginPos, Vec2 endPos) {
        super(pProperties, beginPos, endPos);
    }

    public SS3CowCatcherBlock(Properties properties) {
        super(properties);
    }
