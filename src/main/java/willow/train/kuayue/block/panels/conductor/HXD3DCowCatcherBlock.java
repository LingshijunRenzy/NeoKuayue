...
public class HXD3DCowCatcherBlock extends FullShapeDirectionalBlock implements ConductorProvider {
    public HXD3DCowCatcherBlock(Properties pProperties, Vec2 beginPos, Vec2 endPos) {
        super(pProperties, beginPos, endPos);
    }

    public HXD3DCowCatcherBlock(Properties properties) {
        super(properties);
    }
