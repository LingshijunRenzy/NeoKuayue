...
public class DF5CowCatcherBlock extends FullShapeDirectionalBlock implements ConductorProvider {
    public DF5CowCatcherBlock(Properties pProperties, Vec2 beginPos, Vec2 endPos) {
        super(pProperties, beginPos, endPos);
    }

    public DF5CowCatcherBlock(Properties properties) {
        super(properties);
    }
