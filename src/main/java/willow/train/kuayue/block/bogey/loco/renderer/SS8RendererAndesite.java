...
public class SS8RendererAndesite extends BogeyRenderer {
    ...
    public static final PartialModel
            SS8_FRAME_A = new PartialModel(asBlockModelResource("bogey/ss8//ss8_frame_a")),
            SS8_WHEEL_A = new PartialModel(asBlockModelResource("bogey/ss8/ss8_wheel_a"));
    @Override
    public void initialiseContraptionModelData(
            MaterialManager materialManager, CarriageBogey carriageBogey) {
        this.createModelInstance(materialManager, SS8_FRAME_A);
        this.createModelInstance(materialManager, SS8_WHEEL_A, 2);
    }

    @Override
    public BogeySizes.BogeySize getSize() {
        return AllLocoBogeys.ss8Andesite.getSize();
    }
    ...
    public void render(
        ...
        BogeyModelData frame = getTransform(SS8_FRAME_A, ms, inInstancedContraption);
        BogeyModelData[] wheels = getTransform(SS8_WHEEL_A, ms, inInstancedContraption, 2);
    ...
    public static class Backward extends BogeyRenderer {
        ...
        @Override
        public BogeySizes.BogeySize getSize() {
            return AllLocoBogeys.ss8BackwardAndesite.getSize();
        }
