...
public class CarriageInventoryEvents {
    ...
    private static final int LOCO_TYPE_COUNTS = 6;
    ...
    public void onScreenInit(ScreenEvent.Init.Post event) {
        ...
        locoIcons[5] = new ItemStack(I11Panel.DF11_HEAD.getBlock());
        // 定义左侧向上箭头按钮
    ...
    public void updateLocoMenuItem(CreativeModeInventoryScreen.ItemPickerMenu menu) {
        switch (locoType) {
            ...
            default: // locoType为0时添加所有类型
                ...
                menu.items.addAll(locoItemList.get(4)); // DF11
        }
    }
                ...
                new ArrayList<>() {
                    {
                        ...
                        add(getListByTag(AllTags.I11.tag())); // I11 4
                    }
                };
    }
